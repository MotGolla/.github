...
| ● 메인페이지 화면 <br> ● GPS기반 백화점 조회 <br> ● 리마인드 알림 | ● 투표 내역 및 결과 조회 <br> ● 투표 및 투표 생성 <br> ● 공통 컴포넌트 개발 | ● 상품 추천 기능 <br> ● 기능 상세 페이지 <br> ● 지도 웹뷰 모달 | ● 로그인 및 회원가입 <br> ● 인가, 인증 보안처리 <br> ● 앱 시작, 로그인 화면 | ● 상품 기록 기능 <br> ● 상품 목록 페이지 <br> ● 인프라 구 |
